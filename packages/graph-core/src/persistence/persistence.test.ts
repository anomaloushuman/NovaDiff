...
describe("persistence", () => {
  ...
  describe("saveGraph / loadGraph", () => {
    it("should write knowledge-graph.json to .novadiff-graph/", () => {
      saveGraph(tempDir, sampleGraph);

      const filePath = join(tempDir, ".novadiff-graph", "knowledge-graph.json");
  ...
  describe("saveMeta / loadMeta", () => {
    it("should write meta.json to .novadiff-graph/", () => {
      saveMeta(tempDir, sampleMeta);

      const filePath = join(tempDir, ".novadiff-graph", "meta.json");
      expect(existsSync(filePath)).toBe(true);
    });
  ...
  describe("saveFingerprints / loadFingerprints", () => {
    ...
    it("should return null when fingerprints.json is corrupted", () => {
      const dir = join(tempDir, ".novadiff-graph");
