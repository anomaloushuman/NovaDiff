...
const SESSION_TOKEN_KEY = "novadiff-graph-token";
...
export function DashboardContent({
  ...
  const visibleIssues = useMemo(() => {
    ...
    return allIssues.filter((i) => i.level === "fatal" || i.level === "dropped");
  }, [allIssues, embedMode]);
  ...
  return (
    ...
    >
      ...
      {visibleIssues.length > 0 && !loadError && (
        <WarningBanner issues={visibleIssues} />
      )}
